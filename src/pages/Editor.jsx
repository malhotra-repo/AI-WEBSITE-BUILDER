...
import { Monitor, Rocket, Code2, Send } from 'lucide-react'
...
function Editor() {
 ...
 if (!website) {
  ...
  return (
   <div className="h-screen w-screen flex bg-black text-white justify-center "> Loading.....</div>
  )
    ...
    <div className="p-3 border-t border-white/10 ">
     <div className="flex gap-2">
      <input placeholder='Describe changes...'
       className=' flex-1 resize-none rounded-2xl px-4 py-3 bg-white/5 border border-white/10 text-sm outline-none ' onChange={(e) => setPrompt(e.target.value)} value={prompt} />
